...
let statList1 = [
  {
    ...
    description: ` Poland, Turkey, Spain, Italy, Mexico, Brazil, Argentina and
    Chile`
  },
  {
...
const Card = props => {
  return (
    <div className="stats-item">
      <div className="stats-cart">
        <div className="cart-img">
          <img src={props.item.icon} width="80%" />
        </div>
        <h3 className="card-title">{props.item.title}</h3>
        <p className="cart-desc">{props.item.description}</p>
      </div>
    </div>
  );
};
  ...
  return (
    <section className="stats-section">
      ...
      <div className="stats-items">
        <div className="stats-cart-list-1">
          {statList1.map((el, i) => {
            return <Card item={el} key={i} />;
          })}
        </div>
        <div className="stats-cart-list-2">
          {statList2.map(el => {
            return <Card item={el} />;
          })}
        </div>
